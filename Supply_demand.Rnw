...
text(0.5, 12.5,"(B)", cex=2)
 ...
 plot(predawn_soil_mat_pot, (1- regulated_Gs[1000,]/max(regulated_Gs[1000,1]))*100, lwd=4, col="black", type="l", cex.lab=2.0, cex.axis=2.0, ylim=c(0,100), xlab="Predawn sap pressure, P (-MPa)", , ylab="% loss of conductance (k) and stomatal conductance (Gs)")
