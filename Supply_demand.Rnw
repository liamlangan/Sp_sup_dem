...
points(predawn_soil_mat_pot[100] + delta_P[supply_limit_place_holder[3],100], regulated_trans[supply_limit_place_holder[3],100], type="p", cex=1.8, pch=21, col="red", lwd=3)
...
text(0.5, 12.5,"(B)", cex=2)
 ...
 plot(p_canopy[,1], (1- regulated_Gs[,1]/non_regulated_Gs[,1])*100, lwd=4, col="black", type="l", cex.lab=2.0, cex.axis=2.0, ylim=c(0,100), xlab="Sap pressure (-MPa)", , ylab="% loss of Gs")
lines(p_canopy[,2], (1- regulated_Gs[,50]/non_regulated_Gs[,50])*100, lwd=4, col="azure4", lty=1)
lines(p_canopy[,3], (1- regulated_Gs[,100]/non_regulated_Gs[,100])*100, lwd=4, col="azure4", lty=1)
lines(p_canopy[,4], (1- regulated_Gs[,150]/non_regulated_Gs[,150])*100, lwd=4, col="azure4", lty=1)
lines(p_canopy[,5], (1- regulated_Gs[,200]/non_regulated_Gs[,200])*100, lwd=4, col="azure4", lty=1)
text(0.1, 100,"(C)", cex=2)

plot(p_canopy[,1], (1 - k_p_canopy(p_canopy[,1])/k_p_canopy(0))*100, type="l", ylab="% loss of conductance", xlab="Sap pressure (-MPa)", cex.lab=2.0, cex.axis=2.0,lwd=2.5)
