...
predawn_soil_mat_pot <- seq(0,3, length=5) # this assumes initial plant matric potential is the same as the soil matric potential
...
VPD <- 6.5*0.001   # (Sperry 2016, leaf-to-air vapor pressure deficit 1 kPa) (0.001 converts to MPa) 
...
for(j in 1:5)
{
  ...
  #  demandx[i] <- cum_can_transportx[i,1]
   ...
   non_regulated_Gs[i,j] <- non_regulated_trans[i,j]/VPD # E = G*VPD ---- G = E/VPD (VPD=1, 0.001 transforms to MPa)
  # 
   ...
   regulated_Gs[i,j] <- regulated_trans[i,j]/VPD # E = G*VPD ---- G = E/VPD (VPD=1, 0.001 transforms to MPa)
...
for(i in 1:5)
{
    ...
    min_diff <- regulated_trans[,i] - non_regulated_trans[demand_place_holder[i]]
    min_diff_max <- which(min_diff == max(min_diff))
    min_diff_place_holder[i] <- min_diff_max[1] 
...
%\begin(figure)
\begin{centering}
<<fig.width=16, echo=FALSE, fig.height=16, ,fig.cap="\\label{fig:figs}Hydraulic conductance and transpitation as a function of sap xylem pressure.">>==
...
points(psi_1[demand_place_holder[1],1], non_regulated_trans[demand_place_holder[1],1], type="p", cex=1.6, pch=19, col="black")
points(reg_leaf_psi[min_diff_place_holder[1],1], regulated_trans[min_diff_place_holder[1],1], type="p", cex=1.8, pch=21, col="red", lwd=3)

lines(psi_1[,2], non_regulated_trans[,2], lwd=2)
points(psi_1[demand_place_holder[2],2], non_regulated_trans[demand_place_holder[2],2], type="p", cex=1.6, pch=19, col="black")
points(predawn_soil_mat_pot[2] + reg_leaf_psi[min_diff_place_holder[2],2], regulated_trans[min_diff_place_holder[2],2], type="p", cex=1.8, pch=21, col="red", lwd=3)

lines(psi_1[,3], non_regulated_trans[,3], lwd=2)
points(psi_1[demand_place_holder[3],3], non_regulated_trans[demand_place_holder[3],3], type="p", cex=1.6, pch=19, col="black")
points(predawn_soil_mat_pot[3] + reg_leaf_psi[min_diff_place_holder[3],3], regulated_trans[min_diff_place_holder[3],3], type="p", cex=1.8, pch=21, col="red", lwd=3)

lines(psi_1[,4], non_regulated_trans[,4], lwd=2)
points(psi_1[demand_place_holder[4],4], non_regulated_trans[demand_place_holder[4],4], type="p", cex=1.6, pch=19, col="black")
points(predawn_soil_mat_pot[4] + reg_leaf_psi[min_diff_place_holder[4],4], regulated_trans[min_diff_place_holder[4],4], type="p", cex=1.8, pch=21, col="red", lwd=3)

lines(psi_1[,5], non_regulated_trans[,5], lwd=2)
points(psi_1[demand_place_holder[5],5], non_regulated_trans[demand_place_holder[5],5], type="p", cex=1.6, pch=19, col="black")
points(predawn_soil_mat_pot[5] + reg_leaf_psi[min_diff_place_holder[5],5], regulated_trans[min_diff_place_holder[5],5], type="p", cex=1.8, pch=21, col="red", lwd=3)
...
# points(regulated_leaf_psi[5], regulated_transpiration[5], type="p", cex=1.6, pch=21, col="red", lwd=2)
legend("topleft", c("unregulated transpiration & leaf psi","regulated transpiration & leaf psi","p50=2.5"), col=c("black", "red", "white"), pch = 1, cex=1.5, lwd=2, bty="n")
text(4.5, 24.5,"(A)", cex=2)

 plot(non_regulated_trans[,1], regulated_trans[,1], lwd=4, col="black", type="l", cex.lab=2.0, cex.axis=2.0, ylab="Regulated transpiration rate", xlab="Unregulated transpiration rate")
lines(non_regulated_trans[,2], regulated_trans[,2], lwd=4, col="azure4", lty=1)
lines(non_regulated_trans[,3], regulated_trans[,3], lwd=4, col="azure4", lty=1)
lines(non_regulated_trans[,4], regulated_trans[,4], lwd=4, col="azure4", lty=1)
lines(non_regulated_trans[,5], regulated_trans[,5], lwd=4, col="azure4", lty=1)
text(0.5, 12.5,"(B)", cex=2)

 plot(psi_1[,1], (1- regulated_Gs[,1]/non_regulated_Gs[,1])*100, lwd=4, col="black", type="l", cex.lab=2.0, cex.axis=2.0, ylim=c(0,100), xlab="Sap pressure (-MPa)", , ylab="regulated Gs / unregulated Gs")
