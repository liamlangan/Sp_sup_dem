...
\hlkwa{for}\hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hlnum{5}\hlstd{)}
  \hlstd{\{}
    ...
    \hlkwa{if}\hlstd{(psi_demand_met_at_sperry[i]} \hlopt{<} \hlstd{holder_psi_max_threshold[i])}
    \hlstd{\{}
      \hlstd{regulated_leaf_psi[i]} \hlkwb{<-}  \hlstd{max_leaf_regulation[i]}
    \hlstd{\}}

    \hlstd{ffx} \hlkwb{<-} \hlkwd{integrate}\hlstd{(sperry_cond,} \hlnum{0}\hlstd{, regulated_leaf_psi[i] )}
    ...
    \hlcom{# G[i] <- G[i]*loss_function_sperry[i] # regulated stomatal conductance}
...
## [1] "i"
## [1] 1
## [1] "max_leaf_regulation[i]"
## [1] 1.637212
## [1] "holder_psi_max_threshold[i]"
## [1] 1.971972
## [1] "psi_demand_met_at_sperry[i]"
## [1] 2.707708
## [1] "--------------------------------"
## [1] "i"
## [1] 2
